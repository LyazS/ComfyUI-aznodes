class CrossFadeImageSequence:
    ...
    CATEGORY = "AZNodes"
    DESCRIPTION = "Creates a smooth transition between two image sequences by crossfading."
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
    ...
    def crossfadeimagesequence(self, images_1, images_2, transitioning_frames, interpolation, start_level, end_level):
        import math
        import torch
        ...
        if transitioning_frames > frames_1 or transitioning_frames > frames_2:
            ...
            raise ValueError(f"transitioning frames is too large than input image sequence length: {frames_1} and {frames_2}")
